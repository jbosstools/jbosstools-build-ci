...
The python scripts might need a few extra libs installed. Run these commands first to be sure you have the right dependencies.
...
If you are on Ubuntu you might be affected by this http://stackoverflow.com/questions/27341064/how-do-i-fix-importerror-cannot-import-name-incompleteread[bug]. Solution is to do what is the top answer about doing `apt-get remove python-pip & easy_install pip`
