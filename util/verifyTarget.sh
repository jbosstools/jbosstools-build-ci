...
usage ()
{
  ...
  echo "  -DTARGET_PLATFORM_VERSION_MAX=4.70.0.AM1-SNAPSHOT \\"
  echo "  -z /path/to/eclipse-jee-neon-R-linux-gtk-x86_64.tar.gz  -d /path/to/executable/p2diff \\"
  echo "  -u http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.70.0.AM1-SNAPSHOT/"
  ...
  echo "  -z /path/to/eclipse-jee-neon-R-linux-gtk-x86_64.tar.gz -d /path/to/executable/p2diff \\"
  echo "  -u http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.70.0.AM1-SNAPSHOT/,\\
http://download.jboss.org/jbosstools/targetplatforms/jbtcentraltarget/4.70.0.AM1-SNAPSHOT/"
  echo "          or, use locally built sites"
  echo "  -u file:///path/to/jbosstools-target-platforms/jbosstools/multiple/target/jbosstools-multiple.target.repo/,\\
