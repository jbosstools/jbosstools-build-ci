...
# -z /path/to/eclipse-jee-neon-M1-linux-gtk-x86_64.tar.gz
...
usage ()
{
  ...
  echo "  -z /path/to/eclipse-jee-neon-M1-linux-gtk-x86_64.tar.gz -d /path/to/executable/p2diff"
  echo ""
  echo "Example (JBoss Central - eXclude sources): $0 \\"
  echo "  -b /path/to/jbosstools-discovery -p jbtcentral -x \\"
  echo "  -z /path/to/eclipse-jee-neon-M1-linux-gtk-x86_64.tar.gz  -d /path/to/executable/p2diff \\"
  echo "  -u http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.60.0.Alpha1-SNAPSHOT/,\\
...
file:///path/to/jbosstools-build-sites/aggregate/site/target/"
  ...
  echo "  -u http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.60.0.Alpha1-SNAPSHOT/,\\
http://download.jboss.org/jbosstools/updates/nightly/core/master/,\\
http://download.jboss.org/jbosstools/targetplatforms/jbtcentraltarget/4.60.0.Alpha1-SNAPSHOT/"
  echo "          or, use locally built sites"
  echo "  -u file:///path/to/jbosstools-target-platforms/jbosstools/multiple/target/jbosstools-multiple.target.repo/,\\
file:///path/to/jbosstools-build-sites/aggregate/site/target/,\\
...
#BASEDIR=`pwd`
#ECLIPSEZIP=${HOME}/tmp/Eclipse_Bundles/eclipse-jee-neon-M1-linux-gtk-x86_64.tar.gz
